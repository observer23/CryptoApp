...
class ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        self.colorArray = [UIColor(red: 75/255, green: 57/255, blue: 204/255, alpha: 1),UIColor(red: 15/255, green: 27/255, blue: 100/255, alpha: 1)] // List[]
        getData()
    ...
    func getData(){
        ...
        // fixed url
        WebService().getCurrencies(url: url!) { cryptos in //what happened?
